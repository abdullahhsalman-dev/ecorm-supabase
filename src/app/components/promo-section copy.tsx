      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <div className="relative overflow-hidden rounded-lg bg-gray-900">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center text-white">
            ...
            <p className="mb-4 max-w-md">Discover our latest men's fashion collection for every occasion.</p>
        ...
        <div className="relative overflow-hidden rounded-lg bg-gray-900">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center text-white">
            ...
            <p className="mb-4 max-w-md">Explore our stunning women's fashion collection for every style.</p>
            <Button asChild className="bg-white text-gray-900 hover:bg-gray-100">
