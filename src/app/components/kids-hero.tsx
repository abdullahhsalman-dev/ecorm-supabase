...
export function KidsHero() {
  return (
    <div className="relative h-[500px] overflow-hidden">
      <img src="/placeholder-k2374.png" alt="Kids Collection" className="h-full w-full object-cover" />
      <div className="absolute inset-0 bg-gradient-to-r from-black/70 to-transparent">
        <div className="container flex h-full items-center px-4">
          <div className="max-w-lg text-white">
            <h1 className="mb-4 text-4xl font-bold md:text-5xl lg:text-6xl">Kids Collection</h1>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button asChild size="lg" variant="outline" className="border-white text-white hover:bg-white/10">
                <Link href="/sale/kids">Shop Sale</Link>
              </Button>
            </div>
          </div>
        </div>
